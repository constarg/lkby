object_files = ./build/lkby_transmitter.o ./build/lkby_discovery.o ./build/lkby_queue.o
object_files_debug = ./build/lkby_transmitter_debug.o ./build/lkby_discovery_debug.o ./build/lkby_queue_debug.o
